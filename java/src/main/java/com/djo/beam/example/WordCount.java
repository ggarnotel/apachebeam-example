...
import com.djo.beam.example.common.ExampleUtils;
...
public class WordCount {
  ...
  static class ExtractWordsFn2 extends SimpleFunction<String, String> {

    @Override
    public String apply(String input) {
      if (input.isEmpty())       return super.apply("toto");
